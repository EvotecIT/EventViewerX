...
Time proximity, actor, target, or message similarity alone never proves one occurrence. Bounds fail closed with an incomplete result; they do not silently merge or drop events. Incident reconstruction remains a separate deferred decision.
